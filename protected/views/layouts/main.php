...
<head>
    ...
    <script src="<?php echo Yii::app()->baseUrl;?>/java/jc/bootstrap.js"></script>
    <script src="<?php echo Yii::app()->baseUrl;?>/java/jc/bootstrap.min.js"></script>
    <script src="<?php echo Yii::app()->baseUrl;?>/java/jc/main.js"></script>
    <script src="<?php echo Yii::app()->baseUrl;?>/java/jc/modernizr.js"></script>
    <script src="<?php echo Yii::app()->baseUrl;?>/java/jc/snap.svg-min.js"></script>
