 ...
 * <ul>
 * <li>The first rule says that if the user requests the URL '/path/to/ofice.php/articles',
 *   it should be treated as '/path/to/ofice.php/article/list'; and vice versa applies
 ...
 *   '/path/to/ofice.php/article/13', it should be treated as '/path/to/ofice.php/article/read?id=13';
 ...
 * For example, using the rules above, the URL '/ofice.php/post/123/create'
