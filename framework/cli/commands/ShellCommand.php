 ...
 * entry-script | config-file: optional, the path to
   ...
   the 'ofice.php' file under the current directory.
...
EOD;
	...
	public function run($args)
	{
		if(!isset($args[0]))
			$args[0]='ofice.php';
		$entryScript=isset($args[0]) ? $args[0] : 'ofice.php';
		...
		{
			chdir($cwd);
			$_SERVER['SCRIPT_NAME']='/ofice.php';
			$_SERVER['REQUEST_URI']=$_SERVER['SCRIPT_NAME'];
			$_SERVER['SCRIPT_FILENAME']=$cwd.DIRECTORY_SEPARATOR.'ofice.php';
