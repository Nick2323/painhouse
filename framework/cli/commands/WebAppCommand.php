...
EOD;
	...
	{
		$fileList['ofice.php']['callback']=array($this,'generateIndex');
	...
	/**
	 * Inserts path to framework's yii.php into application's ofice.php
	 *
	...
	public function generateIndex($source,$params)
	{
		...
		$yii=$this->getRelativePath($yii,$this->_rootPath.DIRECTORY_SEPARATOR.'ofice.php');
		$yii=str_replace('\\','\\\\',$yii);
